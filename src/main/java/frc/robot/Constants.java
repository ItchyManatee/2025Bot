...
public final class Constants {
  public static final class DriveConstants {
    ...
    // // Everything cut to 25% to make it more drivable for now
  ...
  public static final class OperatorConstants {
    /* CAN IDs for non-drive Sparks */
    public static final int kAlgaeGrabberCanId = 30;
    public static final int kCoralIntakeCanId = 31;
  }
  ...
  public class ClimberSubsystemConstants {
    ...
    public static int kClimberMotorCanId = 30;

 }

 public class CoralGroundIntakeSubsystemConstants {
